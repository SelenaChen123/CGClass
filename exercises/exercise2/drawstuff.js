...
function main() {
    ...
    var urc = new Color(255,255,0,255); // upper right corner color: green
    ...
    var hDelta = 1 / (urx-ulx-60); // norm'd horizontal delta
    ...
    for (var y=uly; y<=lly; y++) {
        ...
        var frac = (y - uly) / (lly - uly);
        for (var x=ulx; x<=ulx + frac * (lrx - llx); x++) {
